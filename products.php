                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <?php if (!isset($_SESSION['email'])) {                                echo "<p><a href='login.php' role='button' class='btn btn-primary btn-block'>Buy Now</a></p>";
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="cart.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                //We have created a function to check whether this particular product is added to cart or not.
